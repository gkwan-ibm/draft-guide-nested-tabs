...
```
# following -- is end of .tab_content.maven_section
--
...
gradle test
```
# following -- is end of .tab_content.gradle_section
--

# following -- is end of .tab_content.windows_section.mac_section
--
